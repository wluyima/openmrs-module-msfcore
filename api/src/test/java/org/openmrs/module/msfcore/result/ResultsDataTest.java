...
public class ResultsDataTest extends BaseModuleContextSensitiveTest {
    ...
    public void addRetriedResults_shouldAddLabTestOrders() {
        ...
        assertEquals(ResultColumn.builder().value("31/10/2018").editable(true).build(), resultsData.getResults().get(0).get(
                        "msfcore.orderDate"));
        assertEquals(ResultColumn.builder().value("01/11/2018").editable(true).build(), resultsData.getResults().get(0).get(
                        "msfcore.resultDate"));
        ...
        // should retreive actions
        assertEquals(Arrays.asList(ResultAction.values()), resultsData.getActions());
        ...
        // should retrive default pagination
