...
<script type="text/template" id="visitDetailsTemplate">
    ${ ui.includeFragment("msfcore", "patientdashboard/visitDetailsTemplate") }
</script>
...
<script type="text/javascript">
    jq(function(){
        ...
        <% if (param.encounterCount != null) { %>
            encounterCount = ${ param.encounterCount }; // This variable is defined in patientdashboard/msfcorepatientDashboard.gsp
        <% } %>
