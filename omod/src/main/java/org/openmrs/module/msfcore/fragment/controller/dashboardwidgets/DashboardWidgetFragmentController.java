package org.openmrs.module.msfcore.fragment.controller.dashboardwidgets;
...
public class DashboardWidgetFragmentController {
    ...
    public void controller(FragmentConfiguration config, @FragmentParam("app") AppDescriptor app,
                    @InjectBeans PatientDomainWrapper patientWrapper, @SpringBean("adminService") AdministrationService adminService)
                    throws IOException {
