import RecentTestResults from './';
import 'angular-mocks';

describe('RecentTestResults', () => {
	let $componentController;
	let $scope;
	let $httpBackend;
  
	beforeEach(() => {
		angular.mock.module(RecentTestResults);
